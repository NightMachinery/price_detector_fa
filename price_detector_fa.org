...
print('')
ic(extracted_show(unit_extract(sample_1_ht)))
ic(extracted_show(unit_extract(sample_2_ht)))
ic(extracted_show(unit_extract(sample_3_ht)))
None
#+end_src
...
ic| extracted_show(unit_extract(sample_1_ht)): ['مقدار:  ۵ ساعته']
ic| extracted_show(unit_extract(sample_2_ht)): ['مقدار:  یک گرم']
ic| extracted_show(unit_extract(sample_3_ht)): ['مقدار:  یک تن']
#+end_example
